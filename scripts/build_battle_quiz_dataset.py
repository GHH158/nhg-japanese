...
# -*- coding: utf-8 -*-
"""
Generate comprehensive cross-scene battle quiz dataset (window.BATTLE_QUIZ_DATA)
50 curated workplace IT scenario questions across 5 dimensions:
1. objection (🛡️ 异议化解) - 10 questions
2. pitfall (🚫 避坑防雷) - 10 questions
3. elicitation (🔍 需求下钻) - 10 questions
4. scope (📐 范围冻结与Phasing) - 10 questions
5. keigo (👔 高阶商务敬语) - 10 questions
"""
...
questions = [
    # =========================================================================
    # 1. OBJECTION HANDLING (🛡️ 异议化解) - 10 Questions
    # =========================================================================
    {
        "id": "q_obj_01",
        "category": "objection",
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "おっしゃる懸念はごもっともです", "zh": "您的担忧完全在理（极高级的受容共情表达）"},
                {"jp": "負担を減らす部分から限定的に試行する", "zh": "从切实减轻负担的局部展开限定性试点"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "確信度が一定値を下回る", "zh": "置信度低于特定阈值"},
                {"jp": "有人エスカレーション", "zh": "即时升级转接人工坐席"},
                {"jp": "2重の安全設計（フェイルセーフ）", "zh": "双重安全设计（故障保护机制）"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "モックアップでお試しいただく", "zh": "请您用实体交互原型试用体验一下"},
                {"jp": "習得された実績がございます", "zh": "有切实快速上手的落地前例"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "非同期アーキテクチャ", "zh": "异步系统架构"},
                {"jp": "基幹負荷を極小化する", "zh": "将核心基干系统负荷降至最低限度"},
                {"jp": "キューイングによる差分同期", "zh": "基于队列技术的增量差异同步"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "判断を伴うエスカレーション", "zh": "涉及业务决策与权衡的问题升级汇报"},
                {"jp": "ハイブリッド体制で統制する", "zh": "以本地+离岸混合编队体制进行全局管控"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "共通言語として再定義する", "zh": "重新定义为团队协作的共同语言"},
                {"jp": "属人化から組織的ナレッジ共有へ", "zh": "从个人经验主义迈向组织化知识共享"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "匿名加工情報の前処理パイプライン", "zh": "匿名化加工数据的前置处理流水线"},
                {"jp": "監査ログの提示", "zh": "提供可追溯的合规审计日志"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "在庫スナップショットの自動固定", "zh": "自动锁定库存时间戳快照断面"},
                {"jp": "月次締めの業務統制（内部統制）", "zh": "月结业务内部控制与审计合规"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "ブルーグリーンデプロイメント", "zh": "蓝绿部署（零停机切换架构）"},
                {"jp": "切り替えの瞬断を数分に抑える", "zh": "将切换中断时间压缩在数分钟之内"},
                {"jp": "即座にロールバック可能な手順", "zh": "具备即时无损回滚能力的部署流程"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "オフラインキャッシュ＆自動同期", "zh": "离线缓存与自动同步机制"},
                {"jp": "通信が復帰した瞬間にバックグラウンドで同期", "zh": "一旦网络恢复即在后台静默同步"}
            ],
    ...
    # =========================================================================
    # 2. PITFALL AVOIDANCE & BUSINESS ETIQUETTE (🚫 避坑防雷) - 10 Questions
    # =========================================================================
    {
        "id": "q_pit_01",
        "category": "pitfall",
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "承知いたしました / かしこまりました", "zh": "我已获悉/遵命（对客户、上级的标配）"},
                {"jp": "了解しました（NG: 上から目線）", "zh": "知道了（上级对下级用语，对客户是大忌）"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "どのような背景がございましょうか", "zh": "请问是出于什么样的背景考量呢（优雅深挖原因）"},
                {"jp": "差し支えなければ", "zh": "如果不便请包涵 / 在方便的前提下（万能缓冲语）"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "バッドニュースファースト", "zh": "坏消息第一原则（报连相之精髓）"},
                {"jp": "リカバリー策（挽回策）", "zh": "弥补挽回措施方案"},
                {"jp": "事前のアラートを上げる", "zh": "提前拉响风险预警"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "現行の枠組みでは難しゅうございますが", "zh": "在现行框架下恐难以实现，但是..."},
                {"jp": "代替案をご検討いただけますと幸甚です", "zh": "若能考虑替代方案将不胜感激"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "即答いたしかねます", "zh": "请恕我手头现无法即刻作答"},
                {"jp": "持ち帰って検証のうえ", "zh": "待我带回团队严格验证之后..."},
                {"jp": "誤ったご案内を避けるため", "zh": "为避免提供不准确的信息误导贵方"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "事前の共有が不十分で恐縮ですが", "zh": "恕我方事前沟通解释仍不够详尽（先承担半步）"},
                {"jp": "項目の不整合を検出いたしました", "zh": "系统检测到字段定义存在不一致"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "スコープクリープの防止", "zh": "防止范围蠕变蔓延"},
                {"jp": "仕様変更（CR: Change Request）手続き", "zh": "正规需求变更申请流程"},
                {"jp": "影響度調査（工数・費用・納期）", "zh": "影响度评估（工时/费用/纳期）"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "ビジネス価値への翻訳", "zh": "将技术语言转化为业务价值语言"},
                {"jp": "平易な表現（かみ砕いた説明）", "zh": "通俗浅显的生动表达"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "全員に返信（CCの保持）", "zh": "全部回复（严格保留原有抄送人员）"},
                {"jp": "関係者間の情報共有と透明性", "zh": "保持相关利益方间的信息绝对透明"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "私の理解不足でしたら大変恐縮ですが", "zh": "若是我理解有出入还请您见谅（顶级台阶话术）"},
                {"jp": "念のためご確認させていただきたく", "zh": "为稳妥起见想与您做一次确认"}
            ],
    ...
    # =========================================================================
    # 3. REQUIREMENTS ELICITATION (🔍 需求下钻 5W1H) - 10 Questions
    # =========================================================================
    {
        "id": "q_eli_01",
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "ピーク時同時アクセス数", "zh": "高峰期并发访问人数"},
                {"jp": "画面応答速度（レスポンスタイム）目標値", "zh": "界面响应时间目标值"},
                {"jp": "非機能要件定義", "zh": "非功能需求定义"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "データクレンジング工数", "zh": "数据清洗与对齐工时"},
                {"jp": "データライフサイクル（ホット/コールド）", "zh": "数据生命周期管理（冷热分层）"},
                {"jp": "参照用アーカイブとして保持する", "zh": "作为只读归档单独持久化保留"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "緊急度・重要度のクライテリア（判定基準）", "zh": "紧急度与重要度判定准则"},
                {"jp": "チケット自動分類ルール", "zh": "工单自动化分类与路由规则"},
                {"jp": "SLA目標（一次回答時間・完了時間）", "zh": "SLA目标（首响时间与办结时间）"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "二重カウント（再検品）タスクの自動発行", "zh": "自动发起二次复核盘点任务"},
                {"jp": "差異許容範囲と承認ワークフロー", "zh": "差异容差阈值与上级审批工作流"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "権限マトリクス（CRUD権限定義）", "zh": "角色权限矩阵（增删改查及导出权限）"},
                {"jp": "人事異動に伴う組織改編の未来日予約", "zh": "配合人事调动的组织架构改组未来日生效预约"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "RPO（目標復旧時点: Recovery Point Objective）", "zh": "恢复点目标（允许丢失的数据时间范围）"},
                {"jp": "RTO（目標復旧時間: Recovery Time Objective）", "zh": "恢复时间目标（系统停机至恢复的最长耗时）"},
                {"jp": "東西マルチリージョン冗長化", "zh": "东西日本多地域双活跨区容灾冗余"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "動作保証環境（OSバージョン範囲）", "zh": "运行环境保障范围（操作系统版本白名单）"},
                {"jp": "MDM（モバイル端末管理）連携", "zh": "企业级移动设备管理系统集成"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "初回解決率（FCR: First Contact Resolution）", "zh": "首次致电即解决率（客服质量黄金指标）"},
                {"jp": "CSAT（顧客満足度） / NPS（推奨意向度）", "zh": "客户满意度评分 / 净推荐值"},
                {"jp": "経営ダッシュボードでの可視化", "zh": "在经营层仪表盘上进行动态可视化呈现"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "トレーサビリティ（追跡可能性）の担保", "zh": "保障全链路端到端追溯能力"},
                {"jp": "先入れ先出し（FIFO: First-In, First-Out）", "zh": "先进先出库存自动分配调度逻辑"},
                {"jp": "製造ロットと賞味期限の厳密管理", "zh": "生产批次号与保质期严格精细化管理"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "双方向同期と片方向同期の選択", "zh": "双向同步与单向同步的选择权衡"},
                {"jp": "非公開予定のマスキング・除外フィルター", "zh": "非公开私密日程的掩码与剔除过滤"},
                {"jp": "競合（コンフリクト）解消ポリシー", "zh": "并发数据冲突解决仲裁策略"}
            ],
    ...
    # =========================================================================
    # 4. SCOPE MANAGEMENT & PHASING (📐 范围把控与Phasing) - 10 Questions
    # =========================================================================
    {
        "id": "q_sco_01",
        "category": "scope",
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "MoSCoW分析による優先度分け（Must / Should / Could / Won't）", "zh": "MoSCoW需求优先级科学分类"},
                {"jp": "フェーズ分割（Phase 1先行リリース / Phase 2拡張）", "zh": "分期交付规划（一期先行投产/二期延展升级）"},
                {"jp": "スモールスタートでの確実な立ち上げ", "zh": "小步快跑稳妥启动，规避系统性风险"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "仕様変更依頼票（Change Request）の起票", "zh": "提报正式的需求变更申请单"},
                {"jp": "影響度調査（QCD: 品質・費用・納期のトレードオフ）", "zh": "影响度评估（质量/成本/交付周期的权衡分析）"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "Fit to Standard（標準パッケージ適合原則）", "zh": "契合标准原则（业务向成熟标配靠拢）"},
                {"jp": "過剰なアドオン開発の抑止", "zh": "遏制过度个性化挂件开发"},
                {"jp": "TCO（総保有コスト）の最小化", "zh": "最小化整体长期拥有成本"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "受入完了判定基準（合格クライテリア）", "zh": "验收合格判定基准书（Acceptance Criteria）"},
                {"jp": "障害重要度（Severity 1: 致命的 〜 Severity 4: 軽微）", "zh": "缺陷严重度分级机制"},
                {"jp": "検収サインオフの防衛線", "zh": "守护最终验收结案签章的防线"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "定常保守と非定常スポット支援の明確な区分", "zh": "明确区分日常定常运维与临时按需支持"},
                {"jp": "チケット制・工数チャージ枠の消化", "zh": "消耗工单配额/按人月工时单独计费"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "クリック可能な動的プロトタイプ（モックアップ）", "zh": "可点击交互的动态原型（Mockup）"},
                {"jp": "UI仕様の早期フリーズ（合意固定）", "zh": "早期冻结锁定UI界面交互规格"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "責任分界点（デマケーションポイント）の遵守", "zh": "严格恪守系统集成与合同责任分界面"},
                {"jp": "ダミーテストスタブと証跡ログの提示", "zh": "提供联调测试桩与不可辩驳的错误日志证据"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "パイロット拠点（先行実証）によるリスク最小化", "zh": "通过首发试点仓库实证将风险降至最低"},
                {"jp": "段階的ロールアウト（安全な横展開）", "zh": "分阶段多中心横向推广演进策略"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "汎用集計・カスタムレポート機能への統合", "zh": "整合并入通用动态聚合与自定义报表模块"},
                {"jp": "帳票個別開発の工数爆発を抑止", "zh": "遏制报表逐一定制导致的开发工时雪崩"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "残存課題管理表（バックログ）の資産化", "zh": "将遗留课题清单转化为结构化Backlog资产"},
                {"jp": "次期フェーズ（Phase 2）ロードマップの策定", "zh": "制定第二期持续演进升级路线图"}
            ],
    ...
    # =========================================================================
    # 5. BUSINESS KEIGO & COMMUNICATIVE ETIQUETTE (👔 高阶商务敬语) - 10 Questions
    # =========================================================================
    {
        "id": "q_kei_01",
        "category": "keigo",
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "身内（自社）への敬称排除（社長の〇〇）", "zh": "对外部谈及自社领导时直呼其名不带尊称"},
                {"jp": "申す（謙譲語） vs おっしゃる（尊敬語）", "zh": "自己说用申す，客户说用おっしゃる"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "ご高覧いただく（ご覧になるの最高敬度）", "zh": "恭请过目审阅"},
                {"jp": "ご意見を賜れますと幸甚に存じます", "zh": "若能蒙赐宝贵意见将不胜欣幸"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "多大なるご迷惑とご不便をおかけいたしましたこと、深くお詫び申し上げます", "zh": "对给贵方造成的巨大困扰与不便致以最深刻的歉意"},
                {"jp": "再発防止策を即日導入する", "zh": "即日起全面导入防止再发生对策"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "大変心苦しい限りではございますが", "zh": "虽然我内心感到万分过意不去/万般无奈"},
                {"jp": "ご要望に沿いかねる（ご期待に添えず）", "zh": "请恕我方实在难以达到您的预期要求"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "〜という認識でお間違いないでしょうか", "zh": "请问与贵方的认知是否存在出入？（确认核心用语）"},
                {"jp": "ただいま伺いました内容を要約しますと", "zh": "将方才聆听的内容做一简要归纳总结"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "ご査収のほどよろしくお願い申し上げます", "zh": "敬请查收附件（商务邮件标准套话）"},
                {"jp": "お手数をおかけいたしますが", "zh": "给您添麻烦了（常驻润滑剂）"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "心より厚く御礼申し上げます", "zh": "由衷致以最深切的谢意"},
                {"jp": "格段のご高配を賜り", "zh": "蒙受贵方非同寻常的关照与鼎力相助"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "お約束をいただいております", "zh": "与贵司预约在先"},
                {"jp": "お取り次ぎをお願いできますでしょうか", "zh": "劳烦您帮我转接联络一下好吗"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "お話し中大変恐縮ではございますが", "zh": "十分抱歉打断您的谈话（万能插话垫话）"},
                {"jp": "〜の観点から1点だけ補足させていただきたく", "zh": "想从特定角度做一点补充说明"}
            ],
    ...
    },
    {
        ...
        "explanation": {
            ...
            "keyPhrases": [
                {"jp": "無事のカットオーバー、誠におめでとうございます", "zh": "热烈祝贺新系统顺利投产上线"},
                {"jp": "ワンチームとしての揺るぎない絆の賜物", "zh": "正是两家公司如同一体团队般坚不可摧的羁绊结出的硕果"},
                {"jp": "全力で伴走させていただきます", "zh": "我方将全力以赴为您保驾护航、长期伴跑"}
            ],
...
def main():
    ...
    # Write to data/battle-quiz-data.js
    out_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "../data/battle-quiz-data.js"))
    js_content = "// 对日IT全场景实战刷题对决核心题库\nwindow.BATTLE_QUIZ_DATA = " + json.dumps(quiz_data, ensure_ascii=False, indent=2) + ";\n"
    
    with open(out_path, "w", encoding="utf-8") as f:
        f.write(js_content)
    print(f"Successfully generated {len(questions)} questions in {out_path}")

    # Also sync to dist/data/battle-quiz-data.js if dist/data exists
    dist_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../dist/data"))
    if os.path.exists(dist_dir):
        dist_path = os.path.join(dist_dir, "battle-quiz-data.js")
        with open(dist_path, "w", encoding="utf-8") as f:
            f.write(js_content)
        print(f"Successfully synced to {dist_path}")
